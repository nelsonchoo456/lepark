...
import { getDecarbonizationAreasByParkId, DecarbonizationAreaResponse, VisitorResponse } from '@lepark/data-access';
            ...
            >
              <div className="flex flex-row w-full">
                ...
                <div className="h-full flex-1 hidden md:block">
                  <div className="-mt-[2px] text-green-700/80">Park ID: {area.parkId}</div>
                  <div className="-mt-[2px] text-green-700/80">Geometry: {area.geom.substring(0, 20)}...</div>
                </div>
              </div>
            </div>
          ))}
