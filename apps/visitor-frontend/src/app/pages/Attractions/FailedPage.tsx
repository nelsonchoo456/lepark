...
const FailedPage: React.FC = () => {
  ...
  const handleTryAgain = () => {
    navigate(`/attractions/park/${selectedPark?.id}`); // Assuming this is the correct route to try the purchase again
  };
  ...
  return (
    <div className="p-4 h-full overflow-auto flex flex-col items-center">
      ...
      <Card className="w-full max-w-md text-center">
        ...
        <Title level={3}>Your payment was unsuccessful</Title>
        <Text className="block mb-6">
          We're sorry, but there was an issue processing your payment. Please try again or contact our support team if the problem persists.
        </Text>
