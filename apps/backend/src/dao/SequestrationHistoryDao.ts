...
class SequestrationHistoryDao {
  public async createSequestrationHistory(
    data: Prisma.SequestrationHistoryCreateInput
  ): Promise<SequestrationHistory> {
    return prisma.sequestrationHistory.create({ data });
  }

  public async updateSequestrationHistory(
    id: string, 
    data: Prisma.SequestrationHistoryUpdateInput
  ): Promise<SequestrationHistory> {
    return prisma.sequestrationHistory.update({ where: { id }, data });
  }

  public async deleteSequestrationHistory(
    id: string
  ): Promise<void> {
    await prisma.sequestrationHistory.delete({ where: { id } });
  }

  public async getSequestrationHistoryByAreaId(
    areaId: string
  ): Promise<SequestrationHistory[]> {
  ...
  public async deleteSequestrationHistoryForDate(
  ...
  public async getTotalSequestrationForParkAndDate(
    parkId: number, 
    date: Date
  ): Promise<number> {
    const startOfDay = new Date(date.setHours(0, 0, 0, 0));
  ...
  public async getTotalSequestrationForParkAndYear(
    parkId: number, 
    year: number
  ): Promise<number> {
