...
const attractionsData = [
  ...
  {
    title: 'Fresh Water Plants Workshop',
    description:
      "Dive into the fascinating world of freshwater ecosystems with this hands-on workshop that explores the diversity and importance of aquatic plants.",
    openingHours: [
      '2024-09-28T01:00:00.000Z',
      '2024-09-28T01:00:00.000Z',
      '2024-09-28T01:00:00.000Z',
    ...
    images: [
      'https://awalkintheworld.com/wp-content/uploads/2020/05/water-lilies-1024x576.jpeg',
    ],
    status: 'OPEN',
    maxCapacity: 100,
    ticketingPolicy:
      'E-tickets will be sent to the email address that ticket holders have provided at the time of purchase. Admission to the attraction is subject to the presentation of a valid ticket, which may be scanned or checked for authenticity at the entry point. Visitors must adhere to the terms & conditions, including but not limited to any age restrictions or prohibited items.',
    lat: 1.3093400925890442,
    lng: 103.81507158279419,
    parkId: 2,
  },
];
...
const facilitiesData = [
...

  {
    name: 'Toilet A',
    description:
      'Incorporates water-saving and energy-efficient features.',
    isBookable: false,
    isPublic: true,
    isSheltered: true,
    facilityType: 'TOILET',
    reservationPolicy: 'NIL',
    rulesAndRegulations:
      '1. Children under 12 must be supervised by an adult at all times. 2. Maintain cleanliness and dispose of litter in provided bins.',
    images: ['https://live.staticflickr.com/2098/2476291554_0db2c00508_z.jpg'],
    openingHours: [
      '2024-09-07T23:00:00.000Z',
      '2024-09-07T23:00:00.000Z',
      '2024-09-07T23:00:00.000Z',
    ...
    facilityStatus: 'OPEN',
    lat: 1.3109688930890864,
    long: 103.80878448486328,
    size: 200,
    capacity: 50,
    fee: 0,
    parkId: 2,
  },
  {
    name: 'Toilet B',
    description:
      'Includes baby-changing stations and child-sized fixtures.',
    isBookable: false,
    isPublic: true,
    isSheltered: true,
    facilityType: 'TOILET',
    ...
    rulesAndRegulations:
      '1. Children under 12 must be supervised by an adult at all times. 2. Maintain cleanliness and dispose of litter in provided bins.',
    images: ['https://3.bp.blogspot.com/-mIfEGFvVKtk/UQZSQABcuvI/AAAAAAAAFU4/4YQyOoQp-ZQ/s1600/IMG-20121226-00193s.jpg'],
    openingHours: [
      '2024-09-07T23:00:00.000Z',
      '2024-09-07T23:00:00.000Z',
      '2024-09-07T23:00:00.000Z',
    ...
    facilityStatus: 'OPEN',
    lat: 1.3106488027807417,
    long: 103.81683111190796,
    size: 200,
    capacity: 50,
    fee: 0,
    parkId: 2,
  },
  {
    name: 'Toilet C',
    description:
      'Ensures fresh air and a pleasant experience',
    isBookable: false,
    isPublic: true,
    isSheltered: true,
    facilityType: 'TOILET',
    ...
    facilityStatus: 'OPEN',
    lat: 1.3173006225391075,
    long: 103.81567239761354,
    size: 200,
    capacity: 50,
    fee: 0,
    parkId: 2,
  },
  {
    ...
    description:
      'Mountains-inspired play area featuring climbing structures, and slides, designed to engage children in safe fun.',
    isBookable: false,
    isPublic: true,
    isSheltered: false,
    facilityType: 'PLAYGROUND',
    ...
    rulesAndRegulations:
      '1. Children under 12 must be supervised by an adult at all times. 2. No food or drinks allowed on the play equipment. 3. Maintain cleanliness and dispose of litter in provided bins. 4. Please share equipment with others. 5. Pets are not allowed in the playground area.',
    images: ['https://cdn.shopify.com/s/files/1/1301/6863/files/IMG_20210403_110815-01_600x600.jpg?v=1617432728'],
    openingHours: [
      '2024-09-07T23:00:00.000Z',
      '2024-09-07T23:00:00.000Z',
      '2024-09-07T23:00:00.000Z',
    ...
    facilityStatus: 'OPEN',
    lat: 1.3088472242258895,
    long: 103.81635904312135,
    size: 200,
    capacity: 20,
    fee: 0,
    parkId: 2,
...
const newHubs = [
  ...
  {
    serialNumber: 'IA21431241512219',
    identifierNumber: 'HB-X9X9X',
    name: 'Demo Delink Hub 1',
    description: 'Hub for connecting various sensors in the Healing Garden',
    hubStatus: 'ACTIVE',
    acquisitionDate: new Date(),
    supplier: 'Supplier 4',
    ...
    macAddress: '00:00:00:00:00:00',
    dataTransmissionInterval: 5,
    lat: 1.3085689027152907,
    long: 103.8145673274994,
    images: ['https://www.raspberrypi.com/app/uploads/2020/06/raspberrypi_4b-1536x1022.jpg'],
    remarks: 'Newly installed and configured',
    facilityId: '',
    zoneId: 3,
  ...
  {
    serialNumber: 'IA21431241112559',
    identifierNumber: 'HB-X8X8X',
    name: 'Demo Delink Hub 2',
    description: 'Hub for connecting various sensors in the Healing Garden',
    hubStatus: 'ACTIVE',
    acquisitionDate: new Date(),
    supplier: 'Supplier 4',
    ...
    macAddress: '00:00:00:00:00:00',
    dataTransmissionInterval: 5,
    lat: 1.3096185370999367,
    long: 103.81443858146669,
    images: ['https://www.raspberrypi.com/app/uploads/2020/06/raspberrypi_4b-1536x1022.jpg'],
    remarks: 'Newly installed and configured',
    facilityId: '',
    zoneId: 3,
...
const newSensors = [
  ...
  },
  {
    ...
    supplier: 'BrightTech Innovations',
    supplierContactNumber: '89004577',
    lat: 1.308642766513965,
    long: 103.8158440589905,
  ...
  {
    name: 'Temperature (For delink)',
    identifierNumber: 'SE-THROW',
    serialNumber: 'STE123226',
    sensorType: 'CAMERA',
    description: 'Camera for monitoring people in the park',
    sensorStatus: 'ACTIVE',
    acquisitionDate: new Date(),
    ...
    supplier: 'BrightTech Innovations',
    supplierContactNumber: '89004577',
    lat: 1.3101980134661395,
    long: 103.8133442401886,
    images: ['https://i.ytimg.com/vi/YzEZvTwO7tA/maxresdefault.jpg'],
    remarks: 'Installed in an open area',
    facilityId: '',
  },
