...
const attractionTicketListingsData = [
  {
    ...
    category: 'ADULT',
    price: 15,
    description: 'Listing for adults (21 to 59 years old)',
    isActive: true,
    attractionId: '',
  },
  {
    ...
    category: 'CHILD',
    price: 10,
    description: 'Listing for child (3 to 12 years old)',
    isActive: true,
    attractionId: '',
  },
  {
    ...
    category: 'SENIOR',
    price: 10,
    description: 'Listing for seniors (60 years old and above)',
    isActive: true,
    attractionId: '',
  },
  {
...
const promotionsData = [
  ...
  },
  {
    ...
    status: 'ENABLED',
    terms: ['Valid for Earth Day only.', 'This offer is restricted to one claim per user.'],
    isOneTime: false,
  },
  {
    ...
    status: 'ENABLED',
    terms: ['This offer is restricted to one claim per user.', 'A minimum purchase of SGD $30 is required.'],
    minimumAmount: 30,
    isOneTime: true,
  },
  {
    ...
    isNParksWide: false,
    parkId: 2,
    images: ['https://example.com/labour_day_park.jpg'],
    discountValue: 15,
    validFrom: '2024-05-01T08:00:00+08:00',
    validUntil: '2024-05-07T23:59:59+08:00',
    status: 'ENABLED',
    terms: ['This offer is restricted to one claim per user.'],
    maximumUsage: 100,
    isOneTime: true,
  },
  {
    ...
    isNParksWide: true,
    parkId: null,
    images: ['https://example.com/national_day_sustainability.jpg'],
    discountValue: 8,
  ...
  },
  {
    ...
    isNParksWide: true,
    parkId: null,
    images: ['https://example.com/vesak_day_walk.jpg'],
    discountValue: 10,
  ...
  },
  {
    ...
    isNParksWide: false,
    parkId: 1,
    images: ['https://example.com/christmas_nature.jpg'],
    discountValue: 12,
    validFrom: '2024-11-21T08:00:00+08:00',
    validUntil: '2024-11-28T23:59:59+08:00',
    status: 'ENABLED',
    terms: ['A minimum purchase of SGD $50 is required.', 'This offer is restricted to one claim per user.'],
    maximumUsage: 100,
    minimumAmount: 50,
    isOneTime: true,
  },
