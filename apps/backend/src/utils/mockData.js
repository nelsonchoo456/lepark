...
const plantTasksData = [
  ...
  },
  {
    ...
    completedDate: new Date(Date.now()), // Completed today
    submittingStaff: '',
    assignedStaff: '',
    occurrence: '',
  ...
  },
  {
  ...
  },
    {
      ...
      dueDate: new Date('2024-10-18T00:00:00Z'), // Due in 1 day
      completedDate: null,
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
    ...
    },
    {
      ...
      taskUrgency: 'HIGH',
      taskStatus: 'COMPLETED',
      createdAt: new Date('2024-10-13T00:00:00Z'), // 4 days ago
      updatedAt: new Date('2024-10-13T00:00:00Z'), // 4 days ago
      dueDate: new Date('2024-10-16T00:00:00Z'), // Overdue by 1 day
      completedDate: new Date('2024-10-17T00:00:00Z'), // Completed today
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://swanhose.com/cdn/shop/articles/everything-you-should-know-about-deep-watering.jpg?v=1657903183'],
    ...
    // Generated Tasks
    {
      ...
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
      position: 11,
    },
    {
      title: 'Task 4',
    ...
    },
    {
      ...
      taskUrgency: 'NORMAL',
      taskStatus: 'OPEN',
      createdAt: new Date('2024-10-03T00:00:00Z'),
      updatedAt: new Date('2024-10-03T00:00:00Z'),
      dueDate: new Date('2024-10-12T00:00:00Z'),
      completedDate: null,
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
    ...
    },
    {
      ...
      updatedAt: new Date('2024-10-09T00:00:00Z'),
      dueDate: new Date('2024-10-11T00:00:00Z'),
      completedDate: null,
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/soil-maintenance.jpg'],
      position: 14,
    },
    {
      title: 'Task 7',
      ...
      taskUrgency: 'NORMAL',
      taskStatus: 'COMPLETED',
      createdAt: new Date('2024-10-06T00:00:00Z'),
      updatedAt: new Date('2024-10-08T00:00:00Z'),
      dueDate: new Date('2024-10-12T00:00:00Z'),
      completedDate: new Date('2024-10-10T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://149533724.v2.pressablecdn.com/wp-content/uploads/2021/04/pruning-basics.jpg'],
    ...
    },
    {
      ...
      dueDate: new Date('2024-10-09T00:00:00Z'),
      completedDate: null,
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
    ...
    },
    {
      ...
      updatedAt: new Date('2024-10-07T00:00:00Z'),
      dueDate: new Date('2024-10-10T00:00:00Z'),
      completedDate: null,
      submittingStaff: '',
      assignedStaff: '',
    ...
    },
    {
      ...
      taskType: 'ENVIRONMENTAL_ADJUSTMENT',
      taskUrgency: 'HIGH',
      taskStatus: 'COMPLETED',
      createdAt: new Date('2024-10-05T00:00:00Z'),
      updatedAt: new Date('2024-10-08T00:00:00Z'),
      dueDate: new Date('2024-10-12T00:00:00Z'),
      completedDate: new Date('2024-10-09T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://149533724.v2.pressablecdn.com/wp-content/uploads/2021/04/pruning-basics.jpg'],
    ...
    },
    {
      ...
      taskStatus: 'IN_PROGRESS',
      createdAt: new Date('2024-10-04T00:00:00Z'),
      updatedAt: new Date('2024-10-06T00:00:00Z'),
      dueDate: new Date('2024-10-13T00:00:00Z'),
      completedDate: null,
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
    ...
    },
    {
      ...
      updatedAt: new Date('2024-10-08T00:00:00Z'),
      dueDate: new Date('2024-10-12T00:00:00Z'),
      completedDate: new Date('2024-10-11T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
    ...
    },
    {
      ...
      taskUrgency: 'LOW',
      taskStatus: 'COMPLETED',
      createdAt: new Date('2024-09-06T00:00:00Z'),
      updatedAt: new Date('2024-09-09T00:00:00Z'),
      dueDate: new Date('2024-09-12T00:00:00Z'),
      completedDate: new Date('2024-09-10T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
    ...
    },
    {
      ...
      completedDate: new Date('2024-09-20T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
    ...
    {
      title: 'Watering required for the flower garden',
      description: 'Description for task 21',
      taskType: 'WATERING',
      taskUrgency: 'LOW',
      taskStatus: 'COMPLETED',
    ...
    },
    {
      ...
      updatedAt: new Date('2024-09-09T00:00:00Z'),
      dueDate: new Date('2024-09-30T00:00:00Z'),
      completedDate: new Date('2024-09-09T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
    ...
    },
    {
      ...
      updatedAt: new Date('2024-08-10T00:00:00Z'),
      dueDate: new Date('2024-08-30T00:00:00Z'),
      completedDate: new Date('2024-08-20T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
    ...
    },
    {
      ...
      createdAt: new Date('2024-08-06T00:00:00Z'),
      updatedAt: new Date('2024-08-10T00:00:00Z'),
      dueDate: new Date('2024-08-07T00:00:00Z'),
      completedDate: new Date('2024-08-06T00:00:00Z'),
      submittingStaff: '',
      assignedStaff: '',
      occurrence: '',
      images: ['https://example.com/plant-inspection.jpg'],
