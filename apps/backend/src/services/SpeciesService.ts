...
class SpeciesService {
  ...
  public async updateSpeciesDetails(id: string, data: Prisma.SpeciesUpdateInput): Promise<Species> {
    ...
    if (data.speciesDescription) updateData.speciesDescription = data.speciesDescription;
    if (data.conservationStatus) updateData.conservationStatus = data.conservationStatus;
    ...
    if (data.fertiliserRequirement !== undefined) updateData.fertiliserRequirement = data.fertiliserRequirement;
    if (data.idealHumidity !== undefined) updateData.idealHumidity = data.idealHumidity;
    ...
    if (data.isDroughtTolerant !== undefined) updateData.isDroughtTolerant = data.isDroughtTolerant;
    if (data.isFastGrowing !== undefined) updateData.isFastGrowing = data.isFastGrowing;
    if (data.isSlowGrowing !== undefined) updateData.isSlowGrowing = data.isSlowGrowing;
    if (data.isEdible !== undefined) updateData.isEdible = data.isEdible;
    if (data.isDeciduous !== undefined) updateData.isDeciduous = data.isDeciduous;
    if (data.isEvergreen !== undefined) updateData.isEvergreen = data.isEvergreen;
