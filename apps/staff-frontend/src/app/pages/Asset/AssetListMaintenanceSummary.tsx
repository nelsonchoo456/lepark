...
import AssetListMaintenanceTypeTable from './components/AssetListMaintenanceTypeTable';
...
const AssetListMaintenanceSummary: React.FC = () => {
  ...
  const assetTypeTabItems = [
    {
      ...
      children: <AssetListMaintenanceTypeTable parkAssets={parkAssets} triggerFetch={triggerFetch} tableShowTypeColumn/>
    },
    ...parkAssetTypesLabels.map((assetType) => ({
      key: assetType.key,
      label: assetType.label,
      children: <AssetListMaintenanceTypeTable parkAssets={assetsByType[assetType.key]} triggerFetch={triggerFetch}/>
    }))
  ]
  
  const breadcrumbItems = [
    { title: 'Park Asset Maintenance', pathKey: '/parkasset/maintenance', isMain: true, isCurrent: true },
  ];
...
export default AssetListMaintenanceSummary;