  ...
  return (
    ...
    >
      ...
      >
        ...
        <PictureMarker lat={occurrence.lat} lng={occurrence.lng} tooltipLabel={occurrence.title} backgroundColor={COLORS.mustard[200]} icon={<PiPlantFill className='text-highlightGreen-100 drop-shadow-lg' style={{ fontSize: "3rem" }}/>} />
      </MapContainer>
    </div>
    // </>
  );
