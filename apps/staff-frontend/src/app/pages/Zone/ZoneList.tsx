...
const ZoneList: React.FC = () => {
  ...
  return (
    <ContentWrapperDark>
      ...
      <ConfirmDeleteModal onConfirm={deleteZoneToBeDeleted} open={deleteModalOpen} description='Deleting a Zone will delete all of its Occurrences. This cannot be undone.' onCancel={cancelDelete}></ConfirmDeleteModal>
